    ...
    <html lang="en">
      ...
      <body>
        ...
        <main>
          ...
          <pre><code>
          <span style="color: #0E838F">&gt; </span>SELECT COUNT(*) AS count FROM new_users;<br>
          <span style="color: #0E838F">&gt; </span>SELECT COUNT(*) AS count FROM paid_clicks;<br>
          <span style="color: #0E838F">&gt; </span>SELECT COUNT(*) AS count FROM reached_last_scene;<br>
          <br>${content}</code></pre>
          <small class="blue">
